...
const AdminLayout = (props: Props) => {
  return (
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <a href="/list" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">List Sản Phẩm</a>
    ...
    <header className="bg-white shadow">
      ...
      <img className='mx-auto' src="banner" width="400px" />
      </div>
    </header>
 <main className="flex-col bg-indigo-50 w-full ml-4 pr-6">
  <div className="flex justify-between p-4 bg-white mt-3 rounded-xl shadow-lg">
    <h1 className="text-xl font-bold text-gray-700">Welcome to Shop Beo</h1>
